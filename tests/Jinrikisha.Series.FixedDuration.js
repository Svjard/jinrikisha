...
exports.basic = function(test) {
	...
	test.equal(typeof Jinrikisha.Series.FixedDuration, 'function', 'Jinrikisha.Series.FixedDuration is a function');
	test.done();
};
...
exports.initialize = function(test) {
	...
	function instantiateMalformed() {
		...
		var series = new Jinrikisha.Series.FixedDuration(
			[seriesData()], 
			'spectrum2001', 
	...
	test.ok(series instanceof Jinrikisha.Series.FixedDuration);
