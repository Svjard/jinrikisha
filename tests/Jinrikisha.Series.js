...
exports.basic = function(test) {
	...
	test.equal(typeof Jinrikisha.Series, 'function', 'Jinrikisha.Series is a function');
	test.done();
};

exports.initialize = function(test) {

	var series = new Jinrikisha.Series([seriesData()], 'spectrum2001', {timeBase: 0});

	test.ok(series instanceof Jinrikisha.Series);
...
exports.load = function(test) {
	...
	var series = new Jinrikisha.Series([], 'spectrum2001', {timeBase: 0});	
